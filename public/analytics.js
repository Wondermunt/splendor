(function() {
    ...
    (function() {
        function a() {
            for (var a = k, b = {}, c = 0; c < a.length; ++c) b[a[c]] = c;
            return b
        }
        ...
        var c = function(a) {
            ...
            l = function(a, b) {
                ...
                d = d(a.protocol) || d(g.location.protocol);
                ...
                switch (b) {
                    case "protocol":
                        ...
                        break;
                    case "host":
                        a = (a.hostname || g.location.hostname).replace(ca, "").toLowerCase();
                        break;
                    case "port":
                        a = String(Number(a.hostname ? a.port : g.location.port) || ("http" == d ? 80 : "https" == d ? 443 : ""));
                        break;
                    case "path":
                        a = "/" == a.pathname.substr(0, 1) ? a.pathname : "/" + a.pathname;
                        a = a.split("/");
                        0 <= c(a[a.length - 1]) && (a[a.length - 1] = "");
                        a = a.join("/");
                        break;
                    case "query":
                        a = a.search.replace("?",
            ...
            k, w, ha = function(c) {
                ...
                for (var e = "", g = 0;;) {
                    var ca = d(-1),
                        ...
                        ze = d(64),
                        ve = d(64);
                    if (64 === ve && -1 === ca) return e;
                    e += String.fromCharCode(ca << 2 |
                        l >> 4);
                    64 != ze && (e += String.fromCharCode(l << 4 & 240 | ze >> 2), 64 != ve && (e += String.fromCharCode(ze << 6 & 192 | ve)))
                }
            },
            ue, Ge = /(.*?)\*(.*?)\*(.*)/,
            ye = /(.*?)(^|&)_gl=([^&]*)&?(.*)/,
                ...
                return function(b) {
                    ...
                    a: {
                        ...
                        for (var we =
                                0; we < Nd.length; we++) {
                            var w = Nd[we].split("=");
                            if ("_gl" == decodeURIComponent(w[0]).replace(/\+/g, " ")) {
                                Nd = w.slice(1).join("=");
                                break a
                            }
                        }
            ...
            He = function(a, b, c) {
                ...
                g.history && g.history.replaceState && (ye.test(b) || ye.test(c)) && (a = l(a, "path"), b = d(b, "?"), c = d(c, "#"), g.history.replaceState({}, void 0,
                    "" + a + b + c))
            },
            Be = function(a) {
                var b = void 0 === b ? 3 : b;
                        ...
                        if (c && "1" === c[1]) {
                            ...
                            a: {
                                for (a = 0; a < b; ++a) {
                                    ...
                                    var g = a;
                                    g = void 0 === g ? 0 : g;
                                    var ca = [window.navigator.userAgent, (new Date).getTimezoneOffset(), window.navigator.xa || window.navigator.language, Math.floor((new Date).getTime() / 60 / 1E3) - g, e].join("*"),
                                        l;
                                    if (!(l = ue)) {
                                        var w = Array(256);
                                        for (g = 0; 256 > g; g++) {
                                            for (var k = g, da = 0; 8 > da; da++) k = k & 1 ? k >>> 1 ^ 3988292384 : k >>> 1;
                                            w[g] = k
                                        }
                                        l = w
                                    }
                                    ue = l;
                                    g = 4294967295;
                                    for (k = 0; k < ca.length; k++) g = g >>> 8 ^ ue[(g ^
                                        ca.charCodeAt(k)) & 255];
                                    c = (g ^ -1) >>> 0;
                                    if (d === c.toString(36)) {
                                        var te = !0;
                            ...
                            if (te) {
                                b = {};
                                var ve = e ? e.split("*") : [];
                                for (e = 0; e < ve.length; e += 2) b[ve[e]] = ha(ve[e + 1]);
                                return b
                            }
                        }
                    }
            ...
            Ce = function(a, b) {
                ...
                b = {};
                if (c = c.data) d(b, c.query), a && d(b, c.ea);
                return b
            },
            xe = ["google_tag_data", "glBridge", "get"],
            da = this;
        xe[0] in da || "undefined" == typeof da.execScript || da.execScript("var " +
            xe[0]);
        for (var te; xe.length && (te = xe.shift());) {
            var Ae;
            if (Ae = !xe.length) Ae = void 0 !== Ce;
            Ae ? da[te] = Ce : da = da[te] && da[te] !== Object.prototype[te] ? da[te] : da[te] = {}
        }
    })(window);
    var $c = function(a) {
        this.w = a || []
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
        ...
        Jc = function(a, b) {
            ...
            if (a.get(Hd) && (c = be("_ga", a.get(cc)), d = De.get(a.get(cc)), e = d._ga, c || e))
                if (c && e && J(36), a.get(bc)) {
                    if (e && (J(38), a.data.set(Q, e), d._gid && (J(51), a.data.set(I, d._gid)), d._gac && (d = d._gac.split(".")) && 2 == d.length && (J(37), a.data.set(ce, d[0]), a.data.set(fe, d[1]))), c) b: if (d = c.indexOf("."), -1 == d) J(22);
                        else {
                            e = c.substring(0, d);
                            g = c.substring(d + 1);
                            d = g.indexOf(".");
            ...
            a.get(Q) || ((b = (b = O.gaGlobal && O.gaGlobal.vid) && -1 != b.search(jd) ? b : void 0) ? (J(17), a.data.set(Q,
        ...
        Kc = function(a) {
            ...
            if (d && a.get(cc) && (b = M.location.hash)) {
                ...
                for (c = 0; c < b.length; ++c)(D(b[c], "utm_id") ||
                    D(b[c], "utm_campaign") || D(b[c], "utm_source") || D(b[c], "utm_medium") || D(b[c], "utm_term") || D(b[c], "utm_content") || D(b[c], "gclid") || D(b[c], "dclid") || D(b[c], "gclsrc")) && d.push(b[c]);
    ...
    var u = function(a, b, c) {
        ...
        y = function(a, b, c, d, e) {
            if (!ea(Yd.get(b)) && !$d.get(b)) {
                ...
                c && (c && 0 <= c.indexOf("/") || (c = (Ba || "https:" == M.location.protocol ? "https:" : "http:") + "//www.google-analytics.com/plugins/ua/" + c), d = ae(c), a = d.protocol, c = M.location.protocol, ("https:" == a || a == c || ("http:" != a ? 0 : "http:" == c)) && B(d) && (wa(d.url, void 0, e), $d.set(b, !0)))
            }
        },
        v = function(a, b) {
            var c = A.get(a) || [];
        ...
        a: {
            if (b[Kd]) {
                ...
                if (ja.test(M.referrer)) {
                    d = M.location.hostname.replace(/^(?:www\.|m\.|amp\.)+/, "").replace(/-/g, "--").replace(/\./g, "-") + ".cdn.ampproject.org";
                    var e = M.referrer.replace(/^https?:\/\//, "").replace(/(?:\/|\?|#).*$/, "").replace(/^(?:www-|m-|amp-)+/, "");
                    d == e ? (d = (d = De.get()) && d._ga || void 0, void 0 !== d && (Ab = d, J(81))) : J(78)
                }
                if (void 0 !==
                    Ab) b[Q] || (b[Q] = Ab);
                else {
