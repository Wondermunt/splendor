new(function() {
        ...
        switch (typeof b) {
            ...
            case "object":
                ...
                if (p(b)) {
                    var d = b.length;
                    c.push("[");
                    for (var e = "", g = 0; g < d; g++) c.push(e), e = b[g], oa(a, a.Ya ? a.Ya.call(b, String(g), e) : e, c), e = ",";
                    c.push("]");
                    break
                }
                c.push("{");
                ...
                for (g in b) Object.prototype.hasOwnProperty.call(b, g) && (e = b[g], "function" != typeof e && (c.push(d), sa(g, c),
                    c.push(":"), oa(a, a.Ya ? a.Ya.call(b, g, e) : e, c), d = ","));
                c.push("}");
                break;
            case "function":
                break;
    ...
    function Ha(a, b) {
        for (var c = 0, d = ya(String(a)).split("."), e = ya(String(b)).split("."), g = Math.max(d.length, e.length), h = 0; 0 == c && h < g; h++) {
            ...
            do {
                ...
                c = Ia(0 == qa[1].length ? 0 : parseInt(qa[1], 10), 0 == ra[1].length ? 0 : parseInt(ra[1], 10)) || Ia(0 == qa[2].length, 0 == ra[2].length) || Ia(qa[2], ra[2])
            } while (0 == c)
        }
        return c
    }
    ...
    function Ya(a, b) {
        for (var c, d, e = 1; e < arguments.length; e++) {
            d = arguments[e];
            for (c in d) a[c] = d[c];
            for (var g = 0; g < Xa.length; g++) c = Xa[g], Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c])
        }
    }
    ...
    var bb = x("Opera") || x("OPR"),
        z = x("Trident") || x("MSIE"),
        A = x("Gecko") && -1 == w.toLowerCase().indexOf("webkit") && !(x("Trident") || x("MSIE")),
    ...
    f.remove = function(a) {
        return qb(this.A, a) ? (delete this.A[a], this.m--, this.l.length > 2 * this.m && pb(this), !0) : !1
    };
    ...
    function pb(a) {
        ...
        if (a.m != a.l.length) {
            for (var e = {}, c = b = 0; b < a.l.length;) d = a.l[b], qb(e, d) || (a.l[c++] = d, e[d] = 1), b++;
            a.l.length = c
        }
    }
    f.get = function(a, b) {
    ...
    f.log = function(a, b, c) {
        if (a.value >= Bb(this).value)
            for (ea(b) && (b = b()), a = new rb(a, String(b), this.qc), c && (a.qb = c), c = "log:" + a.pc, l.console && (l.console.timeStamp ? l.console.timeStamp(c) : l.console.markTimeline && l.console.markTimeline(c)), l.msWriteProfilerMark && l.msWriteProfilerMark(c), c = this; c;) {
                b = c;
                var d = a;
                if (b.Ba)
                    for (var e = 0, g = void 0; g = b.Ba[e]; e++) g(d);
                c = c.getParent()
            }
    };
    f.info = function(a, b) {
    ...
    H.prototype.add = function(a, b, c, d, e) {
        ...
        var h = Mb(a, b, d, e); - 1 < h ? (b = a[h], c || (b.La = !1)) : (b = new Kb(b, this.src, g, !!d, e), b.La = c, a.push(b));
        return b
    };
    H.prototype.remove = function(a, b, c, d) {
        ...
        var e = this.q[a];
        b = Mb(e, b, c, d);
        return -1 < b ? (Lb(e[b]), v.splice.call(e, b, 1), 0 == e.length && (delete this.q[a], this.Ia--), !0) : !1
    };
    ...
    function K(a, b, c, d, e) {
        ...
        if (a && a[Ib]) a = a.Y(b, c, d, e);
            ...
            h || (a[Ub] = h = new H(a));
            c = h.add(b, c, !1, d, e);
            c.Xa || (d = Zb(), c.Xa = d, d.src = a, d.ia = c, a.addEventListener ? a.addEventListener(b.toString(), d, g) : a.attachEvent($b(b.toString()), d), Wb++);
            a = c
        }
        return a
    }
    ...
    function bc(a, b, c, d, e) {
        ...
        else c = Xb(c), a && a[Ib] ? a.Fb(b, c, d, e) : a && (a = Yb(a)) && (b = a.Aa(b, c, !!d, e)) && cc(b)
    }
    ...
    function cc(a) {
        ...
        var c = a.type,
            d = a.Xa;
        b.removeEventListener ? b.removeEventListener(c, d, a.Ma) : b.detachEvent && b.detachEvent($b(c), d);
        Wb--;
        (c = Yb(b)) ? (Nb(c, a), 0 == c.Ia && (c.src = null, b[Ub] = null)) : Lb(a);
        return !0
    }
    ...
    f.dispatchEvent = function(a) {
        ...
        var e = !0,
            g;
        if (b)
            for (var h = b.length - 1; !a.la && 0 <= h; h--) g = a.currentTarget = b[h], e = gc(g, d, !0, a) && e;
        a.la || (g = a.currentTarget = c, e = gc(g, d, !0, a) && e, a.la || (e = gc(g, d, !1, a) && e));
        if (b)
            for (h = 0; !a.la && h < b.length; h++) g = a.currentTarget = b[h], e = gc(g, d, !1, a) && e;
        return e
    };
    f.p = function() {
        L.F.p.call(this);
    ...
    f.xd = function(a) {
        ...
        if (a.data) {
            ...
            this.va && this.za != b.fid || (a = b.chatango_cmd) && this.Jb[a].apply(this, b.payload ? [b.payload] : [])
        }
    };
    ...
    function P() {
        var a = w.toLowerCase();
        this.xa = -1 != a.indexOf("mobile") && -1 == a.indexOf("kindle") && -1 == a.indexOf("ipad") ? rc : -1 != a.indexOf("android") || -1 != a.indexOf("ipad") || -1 != a.indexOf("silk") ? sc : tc
    }
    n(P);
    var rc = "mobile",
        sc = "tablet",
    ...
    f.Yd = function() {
        if (!this.va) {
            ...
            M.f && this.e.info("syn received, sending cid " + this.ba + " to a child");
            this.send("cid", a)
        }
    };
    f.Qc = function() {
    ...
    f.Mc = function(a) {
        ...
        a == this.za && (M.f && this.e.info("connection established for cid " + this.za), this.va = !0, this.dispatchEvent(new O("connestablished")))
    };
    f.jd = function() {
    ...
    f.Rd = function(a) {
        void 0 !== window.android && void 0 !== window.android.sendToApp && window.android.sendToApp(JSON.stringify(a))
    };
    var yc = null,
        yc = "alecm",
    ...
    function Fc(a, b) {
        var c;
        if (a instanceof Fc) this.B = m(b) ? b : a.B, Gc(this, a.T), c = a.ma, Q(this), this.ma = c, c = a.I, Q(this), this.I = c, Hc(this, a.ka), c = a.K, Q(this), this.K = c, Ic(this, a.D.clone()), c = a.ea, Q(this), this.ea = c;
    ...
    f.toString = function() {
        ...
        if (b = this.K) this.I && "/" != b.charAt(0) && a.push("/"), a.push(Lc(b, "/" == b.charAt(0) ? Nc : Oc, !0));
        ...
        if (c) Hc(b, a.ka);
            ...
            if ("/" != d.charAt(0))
                if (this.I && !this.K) d = "/" + d;
                    ...
                    var e = b.K.lastIndexOf("/"); - 1 != e && (d = b.K.substr(0, e + 1) + d)
                }
            e = d;
            if (".." == e || "." == e) d = "";
    ...
    function Ic(a, b, c) {
        Q(a);
        b instanceof Kc ? (a.D = b, a.D.Eb(a.B)) : (c || (b = Lc(b, Qc)), a.D = new Kc(b, 0, a.B))
    }
    ...
    function Lc(a, b, c) {
        return q(a) ? (a = encodeURI(a).replace(b, Rc), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null
    }
    ...
    function Sc(a) {
        a.k || (a.k = new ob, a.m = 0, a.u && Ec(a.u, function(b, c) {
    ...
    f.remove = function(a) {
        Sc(this);
        a = Tc(this, a);
        return this.k.wa(a) ? (this.u = null, this.m -= this.k.get(a).length, this.k.remove(a)) : !1
    };
    f.clear = function() {
        this.k = this.u = null;
        this.m = 0
    ...
    f.toString = function() {
        ...
        for (var a = [], b = this.k.X(), c = 0; c < b.length; c++)
            for (var d = b[c], e = encodeURIComponent(String(d)), d = this.Q(d), g = 0; g < d.length; g++) {
                var h = e;
    ...
    f.Eb = function(a) {
        a && !this.B && (Sc(this), this.u = null, this.k.forEach(function(a, c) {
            var d = c.toLowerCase();
            c != d && (this.remove(c), this.remove(d), 0 < a.length && (this.u = null, this.k.set(Tc(this, d), Ta(a)), this.m += a.length))
        }, this));
        this.B = a
    };
    f.extend = function(a) {
        for (var b = 0; b < arguments.length; b++) nb(arguments[b], function(a, b) {
            this.add(b, a)
        }, this)
    };
    ...
    function Uc(a) {
        ...
        a && (a = a instanceof Fc ? a.clone() : new Fc(a, void 0), this.Wa = a.T, this.ec = a.I);
        a = Vc(this);
        a == Wc ? this.aa = "chatango.com" : a == Xc ? (this.aa = "chattanga.com", this.ka = Yc) : a == Zc ? this.aa = zc : M.f && a == $c && (this.aa = zc)
    }
    var Wc = "live",
        Xc = "staging",
        Zc = "dev",
    ...
    function Vc(a) {
        ...
        2 <= c.length && "com" == c[0] && "chattanga" == c[1] && (b = 3 <= c.length && "dev2" == c[2] ? Zc : Xc);
        M.f && "file:" == a.Wa && (b = $c);
        return b
    };
    ...
    function ed() {
        ...
        a && (b = ".");
        var c = cd(ad.j());
        return (c.Wa.replace(":", "") || "http") + "://" + a + b + c.aa
    };
    ...
    f.translate = function(a, b) {
        a instanceof S ? (this.x += a.x, this.y += a.y) : (this.x += a, r(b) && (this.y += b));
        return this
    };
    f.scale = function(a, b) {
        var c = r(b) ? b : a;
    ...
    function kd(a) {
        var b = document,
            c = null;
        return (c = b.getElementsByClassName ? b.getElementsByClassName(a)[0] : b.querySelectorAll && b.querySelector ? b.querySelector("." + a) : ld("*", a)[0]) || null
    }
    ...
    function pd(a) {
        ...
        return z && C("10") && a.pageYOffset != b.scrollTop ? new S(b.scrollLeft, b.scrollTop) : new S(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop)
    }
    ...
    function T(a, b, c) {
        ...
        g = e.createElement(g);
        h && (q(h) ? g.className = h : p(h) ? g.className = h.join(" ") : md(g, h));
    ...
    f.removeNode = td;
    f.bc = function(a) {
        return gd && void 0 != a.children ? a.children : Pa(a.childNodes, function(a) {
            return 1 == a.nodeType
        })
    };
    ...
    f.cd = function() {
        var a = od(this.Ja || window),
            b = this.$;
        a == b || a && b && a.width == b.width && a.height == b.height || (this.$ = a, this.dispatchEvent("resize"))
    };
        ...
        if (!(a > this.Vc)) {
            if (a >= this.Rb) {
                ...
                for (i = a - this.Rb; i < a; i++)
                    if (!(0 >= i || this.L[i].ow == this.L[i - 1].ow && this.L[i].iw == this.L[i - 1].iw && this.L[i].ih == this.L[i - 1].ih)) {
                        b = !1;
                        break
                    }
                if (b) {
                    ...
                    if (b !== this.kc || this.zb) this.kc = b, this.Da = a, this.dispatchEvent(new I("c"));
                    else {
                        if (this.hb && Math.abs(a - this.Da) > .25 * this.Da) {
                            var b =
                                Bd.j(),
                                c = a < this.Da;
                            c !== b.xb && ((b.xb = c) ? b.dispatchEvent("keyboardraised") : b.dispatchEvent("keyboardlowered"))
    ...
    f.translate = function(a, b) {
        a instanceof S ? (this.left += a.x, this.right += a.x, this.top += a.y, this.bottom += a.y) : (this.left += a, this.right += a, r(b) && (this.top += b, this.bottom += b));
        return this
    };
    f.scale = function(a, b) {
        var c = r(b) ? b : a;
    ...
    f.contains = function(a) {
        return a instanceof Hd ? this.left <= a.left && this.left + this.width >= a.left + a.width && this.top <= a.top && this.top + this.height >= a.top + a.height : a.x >= this.left && a.x <= this.left + this.width && a.y >= this.top && a.y <= this.top + this.height
    };
    f.v = function() {
        return new R(this.width, this.height)
    };
    ...
    f.translate = function(a, b) {
        a instanceof S ? (this.left += a.x, this.top += a.y) : (this.left += a, r(b) && (this.top += b));
        return this
    };
    f.scale = function(a, b) {
        var c = r(b) ? b : a;
    ...
    function Ld(a, b) {
        return Kd(a, b) || (a.currentStyle ? a.currentStyle[b] : null) || a.style && a.style[b]
    }
    var Md = {
        thin: 2,
        medium: 4,
    ...
    function Ud(a, b, c) {
        ...
        for (b = 0; b < a.jb.length; b++)
            for (c = a.jb[b].type, d = a.jb[b].rules, e = 0; e < d.length; e++)
                if (g = d[e], M.f && a.e.info("Testing rule: " + na(g)), "undefined" !== typeof g.length) {
                    k = !0;
    ...
    function Yd() {
        try {
            return -1 != navigator.userAgent.indexOf("MSIE") ? (new ActiveXObject("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version") : navigator.plugins["Shockwave Flash"].description
        } catch (a) {
            return null
        }
    }
    ...
    function Vd(a, b) {
        ...
        if ("ANDROID" == b.platform) {
            if ("undefined" !=
                typeof b.lessThan && Rd(b.lessThan) || "undefined" != typeof b.atLeast && !Rd(b.atLeast)) return !1
        } else if ("undefined" != typeof b.lessThan && C(b.lessThan) || "undefined" != typeof b.atLeast && !C(b.atLeast)) return !1;
        M.f && a.e.info("Checking rule features");
        if ("undefined" != typeof b.features)
            for (c = 0; c < b.features.length; c++) {
                if ("WEBSOCKET" == b.features[c] && "undefined" == typeof window.WebSocket) return !1;
                ...
                if ("FLASH" == b.features[c] && !Yd() || "NOFLASH" == b.features[c] && Yd()) return !1
            }
        M.f && a.e.info("Checking rule parameters");
        if ("undefined" !== typeof b.param && (M.f && (a.e.info('uri.getParameterValue(rule["param"]): ' + e.D.get(b.param)), a.e.info('typeof uri.getParameterValue(rule["param"]): ' + typeof e.D.get(b.param))), "undefined" === typeof e.D.get(b.param) && (!a.xc || a.xc != b.param))) return !1;
        M.f && a.e.info("Checking rule parameters");
        if ("undefined" !== typeof b.styles)
            if (a.M) switch (b.styles) {
                case "jsr":
                    if (!(a.M.cv &&
                            0 != a.M.cv || a.M.pos && "none" != a.M.pos || a.M.mockgroup)) return !1;
                    break;
                case "is_cv":
                    if (!(a.M.cv && 0 != a.M.cv || a.M.pos && "none" != a.M.pos)) return !1
            } else return !1;
    ...
    function $d(a) {
        var b;
        (b = a.Ob) || (b = {}, ae(a) && (b[0] = !0, b[1] = !0), b = a.Ob = b);
        return b
    };
    var be;
    ...
    f.send = function(a, b, c, d) {
        if (this.d) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.ga + "; newUri=" + a);
        ...
        try {
            Y(this.C, Z(this, "Opening Xhr")), this.ub = !0, this.d.open(b, String(a), !0), this.ub = !1
        } catch (e) {
        ...
        !(0 <= Na(je, b)) || d || c || g.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
        ...
        try {
            le(this), 0 < this.Ha && (this.eb = me(this.d), Y(this.C, Z(this, "Will abort after " + this.Ha + "ms if incomplete, xhr2 " + this.eb)), this.eb ? (this.d.timeout = this.Ha, this.d.ontimeout =
                t(this.Kc, this)) : this.cb = Pd(this.Kc, this.Ha, this)), Y(this.C, Z(this, "Sending request")), this.Ra = !0, this.d.send(a), this.Ra = !1
        } catch (h) {
    ...
    f.Kc = function() {
        "undefined" != typeof aa && this.d && (this.Ca = "Timed out after " + this.Ha + "ms, aborting", Y(this.C, Z(this, this.Ca)), this.dispatchEvent("timeout"), this.abort(8))
    };
    ...
    f.abort = function() {
        this.d && this.o && (Y(this.C, Z(this, "Aborting")), this.o = !1, this.fa = !0, this.d.abort(), this.fa = !1, this.dispatchEvent("complete"), this.dispatchEvent("abort"), this.oa())
    };
    f.p = function() {
        this.d && (this.o && (this.o = !1, this.fa = !0, this.d.abort(), this.fa = !1), this.oa(!0));
        ee.F.p.call(this)
    };
    f.uc = function() {
    ...
    function oe(a) {
        if (a.o && "undefined" != typeof aa)
            if (a.fb[1] && 4 == pe(a) && 2 == qe(a)) Y(a.C, Z(a, "Local request error detected and ignored"));
    ...
    f.oa = function(a) {
        if (this.d) {
            ...
            try {
                ...
                (a = this.C) && a.log(wb, "Problem encountered resetting onreadystatechange: " + d.message, void 0)
            }
        }
    };
    ...
    f.send = function(a, b, c) {
        if (this.t) throw Error("[chatango.networking.XdrIo] Object is active with another request");
        this.ga = a;
        b = b ? b.toUpperCase() : "GET";
        try {
            var d = new XDomainRequest
        } catch (e) {
            throw Error("[chatango.networking.XdrIo: Unable to create XDomainRequest: " + e.message);
        }
        this.t = d;
        this.o = !0;
    ...
    f.abort = function() {
        this.t && this.o && (M.f && this.C.log(Ab, Z(this, "Aborting"), void 0), this.o = !1, this.t.abort(), this.dispatchEvent("complete"), this.dispatchEvent("abort"), se(this))
    };
    f.p = function() {
        re.F.p.call(this);
        se(this)
    ...
    function ve(a, b) {
        ...
        switch (b) {
            ...
            case 0:
                ...
                break;
            case 2:
                X(a, "top", "0px"), X(a, "right", "0px"), X(a, "left", "auto"), X(a, "bottom", "auto")
        }
    };
    ...
    f.Fb = function(a, b, c, d, e) {
        if (p(b))
            for (var g = 0; g < b.length; g++) this.Fb(a, b[g], c, d, e);
        else c = c || this.handleEvent, e = e || this.Qa || this, c = Xb(c), d = !!d, b = a && a[Ib] ? a.Aa(b, c, d, e) : a ? (a = Yb(a)) ? a.Aa(b, c, d, e) : null : null, b && (cc(b), delete this.l[b.key]);
        return this
    };
    f.Fa = function() {
        Ua(this.l, cc);
    ...
    function ye(a, b, c) {
        ...
        this.O = new we(this);
        a = ka(Hb, this.O);
        this.ca ? a.call(void 0) : (this.ja || (this.ja = []), this.ja.push(m(void 0) ? t(a, void 0) : a));
    ...
    f.Gc = function(a) {
        ...
        if (!this.$b || this.da || b && (!(Pb ? 0 == a.P.button : "click" == a.type || a.P.button & Tb[0]) || B && db && a.ctrlKey)) this.dispatchEvent("earlycancel");
        else {
            if (0 == this.fc)
                if (this.dispatchEvent(new Be("start", this, a.clientX, a.clientY, a))) this.da = !0, a.preventDefault();
                else return;
            ...
            ze ? (c.setCapture(!1), this.O.Y(c, "losecapture",
                this.Na)) : this.O.Y(b ? b.parentWindow || b.defaultView : window, "blur", this.Na);
            ...
            this.Hb ? (a = this.target, b = a.offsetLeft, c = a.offsetParent, c || "fixed" != Ld(a, "position") || (c = jd(a).documentElement), c ? (A ? (d = Od(c), b += d.left) : z && 8 <= D && !(z && 9 <= D) && (d = Od(c), b -= d.left), a = "rtl" == Ld(c, "direction") ? c.clientWidth - (b + a.offsetWidth) :
    ...
    f.bd = function(a) {
        if (this.$b) {
            ...
            if (!this.da) {
                ...
                if (d * d + e * e > this.fc)
                    if (this.dispatchEvent(new Be("start", this, a.clientX, a.clientY, a))) this.da = !0;
                    else {
                        this.ca || this.Na(a);
                        return
                    }
            ...
            b = c.x;
            c = c.y;
            this.da && this.dispatchEvent(new Be("beforedrag", this, a.clientX, a.clientY, a, b, c)) &&
    ...
    function Fe(a, b, c, d) {
        a.Hb && Ae(a) ? a.target.style.right = c + "px" : a.target.style.left = c + "px";
    ...
    function Ie(a, b) {
        ...
        this.N = T("div", {
            id: "chatangoDragEl",
            draggable: "true",
            style: "cursor:" + this.Sb + "; width:" + this.nb + "px; height:" + this.nb + "px; z-index:10000000000; position:fixed;"
        });
    ...
    Ie.prototype.qd = function() {
        ...
        Je(this, !0);
        localStorage.setItem(this.Fc, JSON.stringify({
            w: this.qa,
            h: this.pa
        }))
    };
    ...
    function Ke(a, b, c) {
        var d, e, g, h, k = Math.round(a.nb / 2) + 1;
        switch (a.s) {
            case "tl":
                d = b - k;
                g = c - k;
    ...
    function Me() {
        this.ua = !1;
        this.Ea = ad.j();
        M.f && (this.Tc = new nc, oc(this.Tc), F("goog").ab(ub), F("chatango").ab(ub));
        K(window, "pageshow", this.zd, !1, this);
        K(window, "orientationchange", this.tc, !1, this);
        uc() && (this.Ka = document.documentElement.clientWidth / window.innerWidth);
        if (this.n = Ne()) {
            ...
            this.sb = !1;
            uc() && this.g.styles.fwtickm && 0 != this.g.styles.fwtickm && (this.sb = !0, this.g.styles.cv = 1, a = new R(window.innerWidth, .075 * window.innerHeight), this.g.styles.cvw = a.width, this.g.styles.cvh = a.height, this.g.styles.ticker = 1, this.g.styles.cvfntsz = "100%", a = "br");
            this.s = a;
            this.lb = 1 == this.g.styles.cv;
            var c = Ud(Td.j(), this.g.arch, this.g.styles);
            M.f && console.log("Architecture:", c);
            "js" == c || "jsonly" == c ?
                (this.tb = Pe(this, this.n, a), this.i = wc.j(), K(this.i, "resizeiframe", this.Cd, !1, this), K(this.i, "browserviewrequest", function() {
                    this.i.send("browserviewresponse", this.v())
                }, !1, this), K(this.i, "buttonexpanded", this.md, !1, this), K(this.i, "buttoncollapsed", this.ld, !1, this), this.i.Ga(this.c.contentWindow, this.n.id, this.tb, this), K(this.i, "setuserscalable", this.Gd, !1, this), K(this.i, "viewporttoobig", this.Kd, !1, this), K(this.i, "settitle", this.Jd, !1, this), K(this.i, "connestablished", this.nd, !1, this), K(this.i, "enableresizedragger",
                    this.td, !1, this), K(this.i, "kbdown", this.sc, !1, this), K(this.i, "kbup", this.yb, !1, this)) : "flash" == c ? this.wb ? Qe(this, this.n) : Pe(this, this.n, a, c) : "linkandroidchrome" == c ? Re(this, this.n) : "linkandroidff" == c ? Se(this, this.n) : "linkdesktopchrome" == c && Te(this, this.n)
        }
    }
    n(Me);
    var Ue = /^cid\d{10,20}$/;
    ...
    f.td = function(a) {
        var b = a.data.enable;
        b && !this.$a && (this.$a = new Ie(this.c, this.g.styles.pos), K(this.$a, Fd, this.Bd, !1, this));
        if (this.$a)
            if (a = this.$a, b)
                if (a.N.style.display = "block", b = localStorage.getItem(a.Fc), b = JSON.parse(b)) {
                    var c = Ad.j().Lc,
                        b = new R(Math.min(b.w, c.v().width - 20), Math.min(b.h, c.v().height - 20));
    ...
    f.Gd = function(a) {
        switch (a.data) {
            case "disable":
                ...
                if (0 == b.length) this.V = T("META", {
                    name: "viewport",
                    content: "user-scalable=0"
                }), a.appendChild(this.V), this.S = T("META", {
                    name: "viewport",
                    ...
                    this.S = b[b.length - 1];
                    a = {};
                    for (var c = this.S.attributes.length, b = 0; b < c; b++) a[this.S.attributes[b].nodeName] = this.S.attributes[b].nodeValue;
                    if (a.content)
                        ...
                        content: a.content + ", user-scalable=1"
                    }), a.content += ", user-scalable=0";
                    else a.content = "user-scalable=0", this.S.attributes.content = "user-scalable=1";
                    this.V = T("META");
                    md(this.V, a);
                    ud(this.V, this.S)
                }
    ...
    function Pe(a, b, c, d) {
        ...
        if (a.lb) {
            if (a.width = a.g.styles.cvw || 65, a.height = a.g.styles.cvh || 20, g && !a.R && (a.R = Bd.j(), K(a.R, "keyboardraised", a.yb, !1, a), K(a.R, "keyboardlowered", a.rc, !1, a)), g && !a.G) {
                a.G = W.j();
                K(a.G, "a", a.pd, !1, a);
                K(a.G, "c", a.tc, !1, a);
                K(a.G, "b", a.od, !1, a);
                K(a.G, "d", a.Ta, !1, a);
                var h = a.G;
                /ipad|ipod|iphone/gi.test(navigator.appVersion) ? K(document, "gestureend", h.vc, !1, h) : K(document, "touchend",
                    h.vc, !1, h);
                e ? (e = a.G, K(window, "resize", e.wc, !1, e)) : (e = a.G, K(window, "orientationchange", e.yd, !1, e))
            }
        } else e && !a.G && (a.G = W.j(), e = a.G, K(window, "resize", e.wc, !1, e), a.R || (a.R = Bd.j(), K(a.R, "keyboardraised", a.yb, !1, a), K(a.R, "keyboardlowered", a.rc, !1, a)));
        e = Math.floor(256 * Math.random()).toString(16) + String((new Date).getTime()).substr(-4, 4) + a.ba;
        ...
        a.wb && (h = g ? "PMt" : "PMd");
        g = "";
        d && (h = "F", g = "?" + Xe(a), g += "&ref=" + document.location.href.split("?")[0].split("#")[0], g += "&grpnm=" + a.g.handle);
        a.c.src = ed() + "/h5/gz/" + ("r" + Dd.j().lc) + "/i" + h + ".html" + g;
        c ? (X(a.c, "z-index", 2147483648), Ye(a), sd(a.c)) : xd(b) ? sd(a.c) : V(a.c, b);
        b = ed() + "/cfg/nc/r.json?" + e;
        ue.j();
        c = z && !C(10) && Dc(b) != document.domain ? new re : new te(void 0, void 0);
    ...
    f.Ed = function(a) {
        ...
        b = b.cc();
        if ("r" + Dd.j().lc != "r" + a.r)
            if (a = "" + b.substr(b.indexOf("?") + 1), b = document.getElementById(a), b.src = "about:blank", this.c = T("IFRAME", {
                    frameborder: 0,
                    width: b.width,
                    height: b.height,
                    id: a + "_"
                }), this.c.src = "about:blank", ud(this.c, b), a = xc(this), a.cv) X(this.c, "display", "none");
            else {
                b = "<html><body><span style='font:11px sans-serif;'>Please clear your browser cache and refresh to see the latest version of Chatango.</span></body></html>";
                if (window.CloudFlare &&
                    this.n.getAttribute("data-rocketsrc")) {
                    var b = cd(this.Ea).aa,
                        c = [],
                        d = {
                            cid: !0,
                    ...
                    for (style in a) a.hasOwnProperty(style) && !d[style] && c.push(style + ":" + a[style]);
                    b = "<html><body><span style='font:11px sans-serif;'>This Chatango embed code is not compatible with CloudFlare. <a href=\"" + ("http://" + this.g.handle + "." + b + "/clonegroup?style=" + c.join(",")) + '" target="_blank">Get new embed code here.</a></span></body></html>'
                }
    ...
    function Re(a, b) {
        a.Z = T("p", void 0, "This version is not available in your current browser.  ");
        var c = T("a", {
    ...
    function Qe(a, b) {
        ...
        z ? "CSS1Compat" == document.compatMode ? b.parentElement.insertBefore(d,
            b) : (Ze(a), a.J.setAttribute("type", "application/x-shockwave-flash"), V(a.J, b)) : (Ze(a), U(a.J, d), V(a.J, b))
    }
    ...
    function Xe(a) {
        ...
        Vc(cd(a.Ea)) == Zc && (b.push("tagport=20800"), b.push("iconport=1802"), b.push("aimport=5990"), b.push("msnport=2663"));
        return b.join("&")
    }
    ...
    f.tc = function() {
        this.sb ? (this.Ka = -1, this.Ta()) : this.i.send("orientation_change", this.v())
    };
    f.nd = function() {
        this.i.send("inittitle", document.title)
    };
    f.md = function() {
        this.na || (this.na = T("div", {
            style: "width:" + this.c.width + "; height:" + this.c.height + "; display:inline-block"
        }), V(this.na, this.c));
        this.i.disconnect();
        this.ac = !0;
        td(this.c);
    ...
    f.ld = function() {
        this.na && (X(this.na, "display", "none"), this.i.disconnect(), this.ac = !1, td(this.c), V(this.c, this.na), this.i.Ga(this.c.contentWindow, this.n.id, this.tb, this), X(this.c, "position", "static"))
    };
    f.Ib = 0;
    f.Ta = function() {
        ...
        if (a != this.Ka) {
            this.Ka = a;
            var b, c;
            this.s && (this.sb && (c = new R(window.innerWidth, .075 * window.innerHeight), this.width = c.width, this.height = c.height, this.Ib = 1 < this.Ka ? 1 : 0, b = c.width + 2 * this.Ib, c = c.height, this.c.setAttribute("width", b + "px"), this.c.setAttribute("height", c + "px"), X(this.c, "width", b + "px"), X(this.c, "height", c + "px")), Ye(this));
            a = this.v();
    ...
    function Ye(a) {
        if (a.s)
            if (P.j().xa == tc || 1 >= a.Ka) {
                ...
                a.ua && (bc(window, "scroll", a.Ua, !1, a), a.sa && clearTimeout(a.sa), X(a.c, "display", "block"), a.vb = !1);
                a.ua = !1
            } else a.ua = !0, X(a.c, "position", "absolute"), K(window, "scroll", a.Ua, !1, a), $e(a)
    }
    f.yb = function() {
        if (this.$c) {
            if (P.j().xa == sc) {
    ...
    f.rc = function() {
        -1 != navigator.userAgent.indexOf("Android") && this.i && this.i.send("keyboarddown");
        this.sc()
    };
    f.Gb = !1;
    ...
    function af(a, b) {
        ...
        b && !c && a.mb && !a.vb ? (X(a.c, "transition", "opacity .3s ease-in"), X(a.c, "opacity", 1)) : (X(a.c, "transition", "none"), X(a.c, "opacity", 0))
    }
    f.Ua = function() {
        if (this.ua) {
            this.vb = !0;
    ...
    function Ve(a) {
        if (a.s) {
            ...
            switch (a.s[1]) {
                case "r":
                    X(a.c, "left", window.scrollX + window.innerWidth - a.width - b + "px");
                    break;
                case "l":
            ...
            switch (a.s[0]) {
                case "b":
                    X(a.c, "top", window.scrollY + window.innerHeight - a.height + 1 + "px");
                    break;
                case "t":
